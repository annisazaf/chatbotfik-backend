...
# Model informasi chatbot
class InformasiChatbot(db.Model):
    """Informasi yang diinput admin, di-inject ke system prompt saat chatbot menjawab"""
    __tablename__ = 'informasi_chatbot'
